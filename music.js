...
import { StyleSheet, Text, View ,Button,TextInput,CheckBox,TouchableOpacity, LayoutAnimation,Platform,UIManager,ScrollView} from 'react-native';
...
if (Platform.OS === 'android') {
  ...
  <ScrollView style={styles.App}>
    ...
    <View id="list" style={styles.widgetUl} >
        <TouchableOpacity onPress={this._handleRemoveDoneItems} title='Remove' style={styles.buttonRemove}><Text    style={styles.textBt}>Remove </Text></TouchableOpacity>
    </View>
  </ScrollView>
